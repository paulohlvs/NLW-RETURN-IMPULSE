...
export function FeedbackContentStep({ feedbackType, onRestartFeedbackRequest }: FeedbackContentProps) {
        ...
        <>
            ...
            <form className="my-4 w-full">
                ...
                <footer className="flex mt-2 gap-2">
                    <button className="p-2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 ">
                        Enviar Feedback
                    </button>
                </footer>
