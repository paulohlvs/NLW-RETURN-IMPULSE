...
export function FeedbackSuccessStep({onRestartFeedbackRequest}: FeedbackSuccessProps) {
    return (
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <span className="mt-2 text-xl"> Agradecemos seu feedback!</span>
                <button
                    type="button"
                    onClick={onRestartFeedbackRequest}
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent  leading-6 text-sm hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors "
                >
                    Enviar Outro
                </button>
            </div>
